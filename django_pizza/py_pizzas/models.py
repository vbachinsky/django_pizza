...
class Ordered_toppings(models.Model):
...
class Pizza(models.Model):
	...
	ordered_toppings_id = models.ForeignKey(Ordered_toppings, on_delete = models.CASCADE, default=0)
...
class Ordered_snacks(models.Model):
...
class Client_account_person(models.Model):
	client_account_id = models.ForeignKey(Client_account, on_delete = models.CASCADE, default=0)
